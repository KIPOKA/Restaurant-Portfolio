...
const Contact = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-white s">
      ...
      <h3 className="text-2xl font-semibold text-center text-brandPrimary ">Contact Us ! </h3>
        ...
        <Textarea
            ...
            placeholder="Message"
            required
            className="w-full ml-3 text-sm py-4 rounded focus:outline-none focus:border-brandPrimary"
          ...
          <div className="flex justify-center">
            ...
            onClick={handleLogin}
              className={`bg-greenPrimary text-white py-1 px-8 rounded hover:bg-brandSecondary mb-4 ${
                ...
                <h1 className='text-xl'> Send <FaMailBulk/> </h1>
